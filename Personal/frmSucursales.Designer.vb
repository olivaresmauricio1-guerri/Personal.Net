...
Partial Class frmSucursales
    ...
    Private Sub InitializeComponent()
        ...
        Label3.Location = New Point(117, 330)
        ...
        ' TxtDescripcion
        ' 
        TxtDescripcion.Location = New Point(197, 326)
        TxtDescripcion.Margin = New Padding(4, 3, 4, 3)
        TxtDescripcion.Name = "TxtDescripcion"
        TxtDescripcion.Size = New Size(368, 23)
        TxtDescripcion.TabIndex = 22
        ' 
        ' Label2
        ' 
        Label2.AutoSize = True
        Label2.Location = New Point(11, 330)
        ...
        ' TxtId
        ' 
        TxtId.Location = New Point(49, 326)
