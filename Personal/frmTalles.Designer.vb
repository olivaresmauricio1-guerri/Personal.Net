...
Partial Class frmTalles
    ...
    Private Sub InitializeComponent()
        ...
        ' TxtTalle
        ' 
        TxtTalle.Location = New Point(189, 339)
        TxtTalle.Margin = New Padding(4, 3, 4, 3)
        TxtTalle.Multiline = True
        TxtTalle.Name = "TxtTalle"
        TxtTalle.Size = New Size(376, 24)
        TxtTalle.TabIndex = 20
        ' 
        ' Label2
        ' 
        ...
        Label2.TabIndex = 13
        Label2.Text = "Cod Talle:"
        ' 
        ' TxtIdTalle
        ' 
        TxtIdTalle.Enabled = False
        TxtIdTalle.Location = New Point(71, 340)
        TxtIdTalle.Margin = New Padding(4, 3, 4, 3)
        TxtIdTalle.Name = "TxtIdTalle"
        TxtIdTalle.Size = New Size(63, 23)
        TxtIdTalle.TabIndex = 12
        ' 
        ' Label1
        ' 
    ...
    Friend WithEvents TxtIdTalle As TextBox
