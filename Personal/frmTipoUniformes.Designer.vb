...
Partial Class frmTipoUniformes
    ...
    Private Sub InitializeComponent()
        ...
        Label6 = New Label()
        TxtTipoUniforme = New TextBox()
        Label2 = New Label()
        TxtIdTipoUniforme = New TextBox()
        Label1 = New Label()
        ...
        Label6.TabIndex = 21
        Label6.Text = "Tipo Uniforme:"
        ' 
        ' TxtTipoUniforme
        ' 
        TxtTipoUniforme.Location = New Point(247, 339)
        TxtTipoUniforme.Margin = New Padding(4, 3, 4, 3)
        TxtTipoUniforme.Multiline = True
        TxtTipoUniforme.Name = "TxtTipoUniforme"
        TxtTipoUniforme.Size = New Size(318, 24)
        TxtTipoUniforme.TabIndex = 20
        ' 
        ' Label2
        ' 
        ...
        Label2.TabIndex = 13
        Label2.Text = "Cod Tipo:"
        ' 
        ' TxtIdTipoUniforme
        ' 
        TxtIdTipoUniforme.Enabled = False
        TxtIdTipoUniforme.Location = New Point(94, 340)
        TxtIdTipoUniforme.Margin = New Padding(4, 3, 4, 3)
        TxtIdTipoUniforme.Name = "TxtIdTipoUniforme"
        TxtIdTipoUniforme.Size = New Size(40, 23)
        TxtIdTipoUniforme.TabIndex = 12
        ' 
        ' Label1
        ' 
        ...
        Controls.Add(Label6)
        Controls.Add(TxtTipoUniforme)
        Controls.Add(Label2)
        Controls.Add(TxtIdTipoUniforme)
        ...
        MaximizeBox = False
        MinimizeBox = False
        Name = "frmTipoUniformes"
        StartPosition = FormStartPosition.CenterScreen
        Text = "Nomenclador - Tipo Uniformes"
    ...
    Friend WithEvents TxtTipoUniforme As TextBox
    Friend WithEvents Label2 As Label
    Friend WithEvents TxtIdTipoUniforme As TextBox
